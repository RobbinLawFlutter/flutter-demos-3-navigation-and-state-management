...
class AppController extends GetxController {
  final Rx<List<NumberModel>> _appStream = Rx<List<NumberModel>>([]);

  List<NumberModel> get numberType => _appStream.value;

  set numberType(List<NumberModel> value) => _appStream.value = value;
